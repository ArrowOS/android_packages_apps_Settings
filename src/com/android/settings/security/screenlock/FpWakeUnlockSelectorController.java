...
public class FpWakeUnlockSelectorController extends BasePreferenceController
    ...
    public FpWakeUnlockSelectorController(Context context, String key) {
        ...
        mAvailable = (mFingerprintManager.isHardwareDetected() && !isUdfps(context));
    }

    private boolean isUdfps(Context context) {
        final List<FingerprintSensorPropertiesInternal> sensorProperties =
