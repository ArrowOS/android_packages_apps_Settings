...
public class GestureNavigationBackSensitivityDialog extends InstrumentedDialogFragment {
    ...
    private static final String KEY_GESTURE_PILL_TOGGLE = "gesture_pill_toggle"
    ...
    public static void show(SystemNavigationGestureSettings parent, int sensitivity, int height,
        ...
        bundle.putInt(KEY_GESTURE_PILL_TOGGLE, pillState);
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final SystemSettingSwitchPreference pillToggleSwitch = view.findViewById(R.id.gesture_pill_toggle_switch);
        pillToggleSwitch.setChecked(getArguments().getInt(KEY_GESTURE_PILL_TOGGLE));
        return new AlertDialog.Builder(getContext())
                ...
                .setPositiveButton(R.string.okay, (dialog, which) -> {
                    ...
                    getArguments().putInt(KEY_GESTURE_PILL_TOGGLE, pillState);
