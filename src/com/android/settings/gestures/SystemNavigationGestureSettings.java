...
public class SystemNavigationGestureSettings extends RadioButtonPickerFragment 
    ...
    private static SwitchPreference gesturePillToggle;
    ...
    public void onAttach(Context context) {
        ...
        gestureTweaksCategory = new PreferenceCategory(this);
        gestureTweaksCategory.setTitle(getResources().getString(navbar_gesture_mode_category_title));
        gestureTweaksCategory.setKey(getResources().getString(navbar_gesture_mode_category_key));

        gesturePillToggle = new SwitchPreference(this);
    ...
    static void setBackSensitivity(Context context, IOverlayManager overlayManager,
            int sensitivity) {
        BACK_GESTURE_OVERLAYS_TO_USE = getBackGestureOverlaysToUse(context);
    ...
    public static int getPillToggleState(Context context) {
        return Settings.System.getInt(context.getContentResolver(),
                Settings.System.GESTURE_PILL_TOGGLE, 0);
    }

    static final String[] getBackGestureOverlaysToUse(Context context) {
        if (getPillToggleState(context) == 1)
            return BACK_GESTURE_INSET_OVERLAYS_NO_PILL;
        else
            return BACK_GESTURE_INSET_OVERLAYS;
    }
