...
public class SystemNavigationGestureSettings extends RadioButtonPickerFragment {
    ...
    public void onAttach(Context context) {
        ...
        gesturePillToggle.setTitle(getResources().getString(
                    com.android.internal.R.string.navbar_gesture_pill_toggle_title));
        gesturePillToggle.setSummary(getResources().getString(
                    com.android.internal.R.string.navbar_gesture_pill_toggle_summary));
        gesturePillToggle.setChecked(getPillToggleState(context));
    }
    ...
    protected void addStaticPreferences(PreferenceScreen screen) {
        screen.addPreference(gesturePillToggle);
    }

    gesturePillToggle.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
