 ...
 */
public class SystemUICustomPreferenceController extends DeveloperOptionsPreferenceController
        implements Preference.OnPreferenceChangeListener, PreferenceControllerMixin {
    private static final String TAG = "SystemUIOverlayCategoryPC";
    @VisibleForTesting
    static final String PACKAGE_DEVICE_DEFAULT = "package_device_default";
    private static final String OVERLAY_TARGET_PACKAGE_LIGHT = "android_light";
    private static final String OVERLAY_TARGET_PACKAGE_DARK = "android_dark";
    private static final String OVERLAY_TARGET_PACKAGE_BOTH = "android_both";
    ...
    private List<OverlayInfo> overlayInfos;

    @VisibleForTesting
    SystemUICustomPreferenceController(Context context, PackageManager packageManager,
    ...
    public SystemUICustomPreferenceController(Context context, String category) {
	...
	mUiModeManager = mContext.getSystemService(UiModeManager.class);
        ...
        try {
            if (mUiModeManager.getNightMode() == UiModeManager.MODE_NIGHT_YES) {
                overlayInfos = mOverlayManager
                        .getOverlayInfosForTarget(OVERLAY_TARGET_PACKAGE_DARK, USER_SYSTEM);
            } else if (mUiModeManager.getNightMode() == UiModeManager.MODE_NIGHT_NO) {
                overlayInfos = mOverlayManager
                        .getOverlayInfosForTarget(OVERLAY_TARGET_PACKAGE_LIGHT, USER_SYSTEM);
            }

            overlayInfos.addAll(mOverlayManager
                        .getOverlayInfosForTarget(OVERLAY_TARGET_PACKAGE_BOTH, USER_SYSTEM));
