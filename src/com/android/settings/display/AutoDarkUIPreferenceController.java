...
public class AutoDarkUIPreferenceController extends DeveloperOptionsPreferenceController
	...
	int NightDisable = Settings.System.getIntForUser(mContext.getContentResolver(),
            Settings.System.SYSTEM_UI_THEME, 0, UserHandle.USER_CURRENT);
	if (NightDisable == 2 || NightDisable == 3)
	{
	    mUiModeManager.setNightMode(modeToInt((String) "off"));
	    return false;
	} else {
	    return true;
	}
