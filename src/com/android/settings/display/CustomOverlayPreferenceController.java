...
public class CustomOverlayPreferenceController extends DeveloperOptionsPreferenceController
    ...
    private static final String OVERLAY_TARGET_SYSTEMUI_PACKAGE = "com.android.systemui";
	...
	mCustomSettingsObserver.observe();
        ...
        mCategory = category;
        mAvailable = overlayManager != null && !getOverlayInfos().isEmpty() && mUiModeManager.getNightMode() == UiModeManager.MODE_NIGHT_YES;
    }
    ...
    private List<OverlayInfo> getOverlayInfos() {
        ...
        try {
            ...
            overlayInfos.addAll(mOverlayManager
                .getOverlayInfosForTarget(OVERLAY_TARGET_SYSTEMUI_PACKAGE, USER_SYSTEM));
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
		    ...
		    Log.w(TAG, "Dark mode turned off, triggering default overlay");
