...
public class Traffic extends SettingsPreferenceFragment implements
	...
	if (isNetMonitorEnabled || isNetMonitorSBEnabled)
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
	    ...
	    boolean netmonitorSBState = (Boolean) Settings.System.getIntForUser(resolver,
	            Settings.System.NETWORK_TRAFFIC_STATE_SB, 0, UserHandle.USER_CURRENT);
            Settings.System.putIntForUser(getActivity().getContentResolver(),
                    Settings.System.NETWORK_TRAFFIC_STATE, value ? 1 : 0,
                    UserHandle.USER_CURRENT);
            mNetMonitor.setChecked(value);
	    if (value == true || netmonitorSBState)
	        mThreshold.setEnabled(true);
	    else
		mThreshold.setEnabled(false);
            return true;
	    ...
	    boolean value = (Boolean) objValue;
	    boolean netmonitorState = (Boolean) Settings.System.getIntForUser(resolver,
